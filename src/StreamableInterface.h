...
namespace AZ
{
    ...
    public:
        ...
        virtual Streamable& operator<<(uint16_t) = 0;
        ...
        virtual Streamable& operator<<(const ::std::string_view&) = 0;
    };
    ...
    public:
        ...
        Streamable& operator<<(int n) override                    { m_wrappedStream << n; return *this; }
        Streamable& operator<<(uint16_t n) override               { m_wrappedStream << n; return *this; }
        ...
        Streamable& operator<<(const ::std::string_view& str) override { m_wrappedStream << str; return *this; }
